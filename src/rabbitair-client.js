				...
				return [2 /*return*/, new Promise((resolve, reject) => {
					...
					if (_this.token) {
						...
						if (_this.tsDiff === null) {
							...
							_this.socket.send(encryptedTsData, _this.port, _this.host, (err) => {
								if (err) {
							...
							var onTsMessage_1 = function (msg) {
								...
								try {
									...
									if (response.id === tsRequest_1.id) {
										...
										_this.socket.send(encryptedCommandData, _this.port, _this.host, (err) => {
											if (err) {
						...
						_this.socket.send(commandData, _this.port, _this.host, (err) => {
							if (err) {
							...
							return __generator(this, (_c) => {
								switch (_c.label) {
									...
									case 2:
										...
										return [4 /*yield*/, new Promise((resolve) => {
