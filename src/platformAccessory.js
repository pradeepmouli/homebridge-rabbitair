...
var RabbitAirAccessory = /** @class */ (function (_super) {
    ...
    function RabbitAirAccessory(platform, accessory) {
        ...
        _this.services.airPurifier.characteristics.Active.onSet(function (value) { return __awaiter(_this, void 0, void 0, function () {
    ...
    RabbitAirAccessory.prototype.startPeriodicUpdates = function () {
        ...
        this.initialUpdateTimeout = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        if (!(targetState === this.platform.Characteristic.TargetAirPurifierState.AUTO)) return [3 /*break*/, 3];
